...
| A12 | 2026-09-25 | **Professors follow the same strike rules as everybody else**: task strikes and the jail ladder, KPI strikes (3 = held awaiting deletion), deletion on Marc's routed intent. A jailed professor can't examine or step in. | professors are agent records with `role: 'professor'` |
